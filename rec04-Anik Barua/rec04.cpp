/*
Name: Anik Barua
Program: rec04: Pointer Tutorial
Verison: 1.0
Date: 02-18-2022
*/
...
public:       
    ...
    void movesInWith(Person& newRoomate) {
        // 3 test(s)
        if(this != &newRoomate && roomie == nullptr && newRoomate.roomie == nullptr){
            roomie = &newRoomate;        // now I have a new roomie            
            newRoomate.roomie = this;    // and now they do too    
        } else {
            cout << "Cannot be roommate of yourself!" << endl;
        }
    }
...
int main(){
    ...
    *pDyn = 17;
    ...
    //delete pShrt; // pointer being freed was not allocated
    delete pShrt;
    ...
    speaker1.vibrateSpeakerCones(220);
    amplifier1.attachSpeakers(speaker1);
    amplifier1.playMusic();
    cout << "\n";

    speaker2.vibrateSpeakerCones(300);
    amplifier2.attachSpeakers(speaker2);
    amplifier2.playMusic();
    cout << "\n";

    amplifier1.detachSpeakers();
    amplifier1.attachSpeakers(speaker2);
    amplifier1.playMusic();
    cout << "\n";
